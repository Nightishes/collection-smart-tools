...
if (fs.existsSync(filePath)) {
    ...
    console.log('Contains HTML comment:', content.includes('<!-- Created by pdf2htmlEX'));
    console.log('Contains meta generator:', content.includes('<meta name="generator" content="pdf2htmlEX"'));
    console.log('Contains Base CSS comment:', content.includes('* Base CSS for pdf2htmlEX'));
    console.log('Contains Fancy CSS comment:', content.includes('* Fancy styles for pdf2htmlEX'));
